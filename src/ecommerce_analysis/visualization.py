...
def plot_monthly_sales_trend(monthly_stats: pd.DataFrame) -> plt.Figure:
    ...
    ax1.plot(monthly_stats.index.astype(str), monthly_stats['total_revenue'], 
             marker='o', linewidth=2, color='blue', label='Total Revenue')
    ...
    ax2 = ax1.twinx()
    ax2.plot(monthly_stats.index.astype(str), monthly_stats['transaction_count'], 
             marker='s', linewidth=2, color='orange', linestyle='--', label='Transactions')
